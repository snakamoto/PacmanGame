...
class TDGraphicsScene : public QGraphicsScene
{
    Q_OBJECT
public:
    explicit TDGraphicsScene(int, int, int, int, QGraphicsView*);
    ...
    void LoadMap(QString fileName, QPoint start, QPoint end);
    void SetNewTowerIndex(int i);
    void LoadPostMapItems();
...
private:
    ...
    TileNode t_[TILES_X][TILES_Y]; //Array allocation trick coz I'm n00b
    TileNode startNode;
    TileNode endNode;
    void GeneratePath();
